...
![Chapter page](/en/envs/pages/images/pages-chapter.png?width=50pc)
...
![Default page](/en/envs/pages/images/pages-default.png?width=50pc)
...
**Hugo-theme-learn** provides [archetypes]({{< relref "envs/archetypes.en.md" >}}) to help you create this kind of pages.
...
![Title with icon](/en/envs/pages/images/frontmatter-icon.png)
