...
| <strong><span style="color:#5B5B60;">Original ROM Name</span></strong>   | `xmvsf.zip`       |
| <strong><span style="color:#5B5B60;">SHA256 Checksum</span></strong>  | `todo`        | 
| <strong><span style="color:#5B5B60;">Search Keywords</span></strong>   | `X-Men VS Street Fighter CPS2`, x-men-vs-street-fighter`, `todo`, `allmyroms`     |
...
| <strong><span style="color:#5B5B60;">Number of Characters (Selectable)</span></strong>  | 17   |
...
| `characters`| `string`       | [[`Random`],&#160;[`Random`]] | TODO |
