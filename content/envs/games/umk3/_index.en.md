...
| `characters`                                             | `string` or `tuple` of maximum three `strings`            | `Random`                                                              | Kitana, Reptile, Kano, Sektor, Kabal, Sonya, Mileena, Sindel, Sheeva, Jax, Ermac, Stryker, Shang Tsung, Nightwolf, Sub-Zero-2, Cyrax, Liu Kang, Jade, Sub-Zero, Kung Lao, Smoke, Skorpion |
| `char_outfits`                                           | `int`                                                     | 2                                                                     | [1, 2]                                                                                                                                                                                    |
