...
{{% notice warning %}}
DEPRECATED: For speed, consider using the environment setting `frame_shape` that performs the same operation on the engine side, as described in <a href="../envs/#environment-settings">this section</a>.
{{% /notice %}}
